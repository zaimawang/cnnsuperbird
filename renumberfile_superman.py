...
def increment_file_numbers(directory, string, integer):
    ...
    for file_name in os.listdir(directory):
        ...
        # example format : superman.01.jpg
...
# C:\Users\ACER\Downloads\google-images-download-master\superman
PATH = os.path.abspath('/Users/ACER/Downloads/google-images-download-master/superman')
objectname = "superman"
startcount = 0
